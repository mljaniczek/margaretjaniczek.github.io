...
### Bayesian spike-and-slab Graphical Lasso

I created a detailed tutorial describing how to use Bayesian Joint Spike-and-slab Graphical Lasso (Li et. al) analysis in R, with examples using a real-world metabolomics dataset. You can view the full tutorial [here](https://mljaniczek.github.io/ssjgl-tutorial). 
