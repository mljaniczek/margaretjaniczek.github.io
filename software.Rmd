...
### CRAN Packages
#### `gtsummary`
I contribute to the [gtsummary](http://www.danieldsjoberg.com/gtsummary/) package.
...
#### `riskybiz`
I am the author and maintainer of the [riskybiz](https://margarethannum.github.io/riskybiz/) package which contains wrapper and helper functions to get tidy competing risks regression model results from the {cmprsk} package.
